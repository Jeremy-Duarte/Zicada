...
from .models import GalleryPhoto, HeroConfig
...
class GalleryPhotoForm(FormStyleMixin, SortableCreateMixin, SortableUpdateMixin, forms.ModelForm):
    ...
    El admin elige explícitamente display_size (1x1 o 2x2).
    """
    ...
    class Meta:
        ...
        widgets = {
            ...
            'display_size': forms.Select(choices=GalleryPhoto.DISPLAY_SIZE_CHOICES),
